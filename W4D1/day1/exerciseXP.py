...
computer_branch = 'mac'
print(f"I have a {computer_branch} computer   ")
...
age = 25
shoe_size = 46
info = ' i play football'
print(f'my name is {name} im {age} my shoe-size {shoe_size} and {info}')
...
inches = int(input('Whats your height in inches'))
