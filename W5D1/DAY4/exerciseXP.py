...
#         # random2 = random.choice(word_list)
#         # random3 = random.choice(word_list)
#         # random4 = random.choice(word_list)
#         list = []
...
#         #  finalList = randomlist, random2, random3, random4
#         #  finalList = str(finalList).lower()
...
#     get_random_sentence(file,user1)
