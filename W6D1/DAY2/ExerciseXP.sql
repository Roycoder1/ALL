...
-- select film_id,title,description,length,rental_rate from film where title iLike 'The green mile'
...
-- select g.amount, g.payment_date, p.first_name,p.last_name
-- from customer as p 
-- inner join payment  as g
-- on p.customer_id = g.customer_id;
-- You need to check your inventory. Write a query to get all the movies which are not in inventory.
-- select *from inventory
-- select g.title,p.film_id 
-- from inventory as p 
-- inner join film  as g
-- on p.film_id = g.film_id;
-- Write a query to find which city is in which country.
select g.country,p.city
from city as p 
inner join country  as g
